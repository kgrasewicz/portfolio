...
$(document).on("mousemove", function parallax(e) {
  document.querySelectorAll(".about__content__images").forEach(function (move) {
...
$(document).ready(function () {
  ...
  .on("mousedown", function (event) {
    timeout_id = setTimeout(function () {
      ...
      $(".about__content__scroll-line__circle__progress-ring").addClass("visible");
    ...
    setTimeout(function () {
      $(".about__content__title-3").css({ width: "24vw", height: "32vw", animation: "none" });
